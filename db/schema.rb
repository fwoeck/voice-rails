...
ActiveRecord::Schema.define(version: 20140628142144) do
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "allow",                  limit: 100, default: "opus,speex16,alaw,ulaw"
    ...
    t.string   "transport",              limit: 10,  default: "udp,tls"
